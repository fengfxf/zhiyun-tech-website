...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <TooltipPrimitive.Content
    ...
    className={cn(
      ...
      "before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-r before:from-primary-500/10 before:via-transparent before:to-primary-500/10 before:animate-pulse",
      className
    )}
    {...props}
  />
